...
export default function Loader({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 bg-linear-to-r from-transparent via-white/60 to-transparent dark:via-gray-700/40 animate-pulse" />

      <div className="relative z-10 mx-auto flex w-full max-w-2xl flex-col gap-6">
        <div className="flex items-center gap-4">
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 ring-1 ring-gray-200 dark:bg-gray-700 dark:ring-gray-600">
            <span className="h-6 w-6 animate-spin rounded-full border-2 border-gray-300 border-t-gray-800 dark:border-gray-600 dark:border-t-gray-200" />
          </span>
