...
const ENTITY_PATHS = {
  ...
  contract: "/sap/opu/odata4/sap/zsc_purch_cotract_o4/srvd_a2x/sap/zsc_purch_cotract_api/0001/PurchaseContractAPI",
  ...
  invoice: "/sap/opu/odata4/sap/zsc_invoice_o4/srvd_a2x/sap/zsc_invoice_api/0001/InvoiceDocument",
};
      ...
      const request = https.request(options, (response) => {
        ...
        response.on("end", () => {
          if (response.statusCode >= 400) {
            reject(new Error(`SAP вернул ${response.statusCode}: ${body.slice(0, 300)}`));
            return;
          }
          try {
